...
/**
 * Controlador para la vista del menú del administrador. Maneja eventos de mouse
 * para los botones y gestiona las interacciones de usuario.
 */
public class AdmMenuController implements MouseListener {
    ...
    /**
     * Inicia la interfaz de usuario del administrador cargando los datos
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if (e.getSource() == this.vistaAdm.jlblCerrar) {
            ...
            if (!isOpenVentaVenta) {
                AdmVentaController venCtrl = new AdmVentaController(vistaAdm, modelo);
                isOpenVentaVenta = true;
            }
    ...
    /**
     * Cambia el color del botón clicado y restaura el estado de los botones
